    ...
    public class ProductServiceTest
    {
        ...
        public static void ProductServiceTestInitialize(TestContext testContext)
        {
            ...
            var testDataProduct = new List<Product>
            {
                new()
                {
                    ID = 1, Name = "MockProduct1", EAN = "EAN02117", ValidFrom = new DateTime(2021, 02, 01),
                    ValidTo = new DateTime(2021, 02, 15)
                },
                new()
                {
                    ID = 2, Name = "MockProduct2", EAN = "EAN02118", ValidFrom = new DateTime(2021, 02, 01),
                    ValidTo = new DateTime(2021, 02, 15)
                },
                new()
                {
                    ID = 3, Name = "MockProduct3", EAN = "EAN02119", ValidFrom = new DateTime(2021, 02, 01),
                    ValidTo = new DateTime(2021, 02, 15)
                },
                new()
                {
                    ID = 4, Name = "MockProduct4", EAN = "EAN02120", ValidFrom = new DateTime(2021, 02, 01),
                    ValidTo = new DateTime(2021, 02, 15)
                },
                new()
                {
                    ID = 5, Name = "MockProduct5", EAN = "EAN02121", ValidFrom = new DateTime(2021, 02, 01),
                    ValidTo = new DateTime(2021, 02, 15)
                },
                new()
                {
                    ID = 6, Name = "MockProduct6", EAN = "EAN02122", ValidFrom = new DateTime(2021, 02, 01),
                    ValidTo = new DateTime(2021, 02, 15)
                }
            };
            testDataProduct.ForEach(p => _productService.AddProductsAsync(p));
        }
        ...
        {
            Product productWithValidDate = new()
            {
                ID = 8, Name = "productWithValidDate", EAN = "EAN12345", ValidFrom = new DateTime(2021, 02, 01),
                ValidTo = new DateTime(2021, 02, 15)
            };
            var insertedProduct = _productService.AddProductsAsync(productWithValidDate);
        ...
        public void AddProducts_With_Bad_Valid_Date()
        {
            ...
            {
                Name = "BadProduct", EAN = "EAN12346", ValidFrom = new DateTime(2021, 02, 18),
                ValidTo = new DateTime(2021, 02, 15)
            };
            Assert.ThrowsException<ArgumentException>(() => _productService.AddProductsAsync(newProduct));
        }
    }
}